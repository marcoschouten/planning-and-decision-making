...
class RRTStar(RRT):
    ...
    def plan(self):
        ...
        for i in range(self.max_iter):
            ...
            if not self.map.collision(nearest_node.p, new_node.p):
                # add the node to tree, update the parent by costs
                self.add(new_node)
    ...
    def add(self, new_node):
        ...
        # TODO compare: rewire or unrewire
        # Explanation of rewiring is given below
        # https://blog.csdn.net/reasonyuanrobot/article/details/107411743
    ...
    def near_nodes(self, node):
        ...
        #TODO using number to inspect near nodes, rather than radius?
