...
class Waypoint_insertion_trajOpt:
    ...
    def cost_cal(self,T):
        ...
        self.min_snap_traj()
        return self.cost
######  Following optimiza function takes reference from https://github.com/Bharath2/Quadrotor-Simulation/blob/b6380c36c7bfec635242b9de2dc967ee81703f70/TrajGen/trajGen.py#L25####
    def optimize(self):
        position = self.waypoints[:, :3]
        displacement_vec = position[1:]-position[:-1]
